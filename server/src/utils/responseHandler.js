...
//A constructor is a method for creating and initializing an object instance of a class, while the sper keyword is used to call and invoke the parent class which gives to it properties and methods
class AppError extends Error {
  constructor(message, statusCode = 500) {
    ...
    this.isOperational = true  //distinguish between operational erros, such as server shutdown or connection, validation errors, authentication errors while programmer errors should not be sent to the client - bugs, syntax errors, or type errors.
  }
}
